...
/* 69cefae83392e5b1d76acd8e9e9778e9b2b47ff6 */
class __TwigTemplate_52b33c0006f84605815bb24968314d62 extends Template
{
    private $source;
    private $macros = [];
    ...
    protected function doDisplay(array $context, array $blocks = [])
    {
        ...
        echo "
          ";
        // line 2
        $macros["macros"] = $this->macros["macros"] = $this->loadTemplate("macros.twig", "69cefae83392e5b1d76acd8e9e9778e9b2b47ff6", 2)->unwrap();
        // line 3
        echo "
          ";
        // line 4
...
";
        ...
        echo "
          ...
          <div class=\"breakdance-form-field breakdance-form-field--text\" >
            ...
            <label class=\"breakdance-form-field__label\" for=\"nomor\">
            Nomor Resi</span>
        </label>
...
<footer class=\"breakdance-form-field breakdance-form-footer\">
    ";
        ...
        foreach ($context['_seq'] as $context["_key"] => $context["step"]) {
            ...
            echo twig_get_attribute($this->env, $this->source, $context["loop"], "index", [], "any", false, false, false, 73);
            echo "\">
            ";
            // line 74
            echo twig_call_macro($macros["macros"], "macro_atomV1ButtonHtmlManual", [(((twig_get_attribute($this->env, $this->source, $context["step"], "previous_button_text", [], "any", true, true, false, 74) &&  !(null === twig_get_attribute($this->env, $this->source, $context["step"], "previous_button_text", [], "any", false, false, false, 74)))) ? (twig_get_attribute($this->env, $this->source, $context["step"], "previous_button_text", [], "any", false, false, false, 74)) : ("Previous Step")), false, "breakdance-form-button breakdance-form-button__previous-step hidden", ($context["previousStepButtonDesign"] ?? null), "secondary", false, false, "step.next_button_text"], 74, $context, $this->getSourceContext());
            echo "
            ";
            // line 75
            echo twig_call_macro($macros["macros"], "macro_atomV1ButtonHtmlManual", [(((twig_get_attribute($this->env, $this->source, $context["step"], "next_button_text", [], "any", true, true, false, 75) &&  !(null === twig_get_attribute($this->env, $this->source, $context["step"], "next_button_text", [], "any", false, false, false, 75)))) ? (twig_get_attribute($this->env, $this->source, $context["step"], "next_button_text", [], "any", false, false, false, 75)) : ("Next Step")), false, "breakdance-form-button breakdance-form-button__next-step hidden", ($context["nextStepButtonDesign"] ?? null), "primary", false, false, "step.next_button_text"], 75, $context, $this->getSourceContext());
            echo "
        </div>
    ";
            ++$context['loop']['index0'];
        ...
        // line 78
        echo "    ";
        echo twig_call_macro($macros["macros"], "macro_atomV1ButtonHtmlManual", [(($context["submitButtonText"]) ?? ("Submit")), false, "breakdance-form-button breakdance-form-button__submit", ($context["submitButtonDesign"] ?? null), "primary", ($context["submitButtonId"] ?? null), true, "content.form.submit_text"], 78, $context, $this->getSourceContext());
        echo "
  ...
  ";
    ...
    {
        return "69cefae83392e5b1d76acd8e9e9778e9b2b47ff6";
    }
    ...
    {
        return array (  243 => 83,  234 => 78,  217 => 75,  213 => 74,  208 => 73,  191 => 72,  185 => 69,  149 => 35,  144 => 32,  128 => 29,  122 => 27,  120 => 26,  117 => 25,  111 => 23,  105 => 21,  103 => 20,  97 => 18,  80 => 17,  76 => 15,  74 => 14,  70 => 13,  56 => 12,  53 => 11,  51 => 9,  50 => 8,  49 => 6,  47 => 5,  45 => 4,  42 => 3,  40 => 2,  37 => 1,);
    }

    public function getSourceContext()
    {
        return new Source("", "69cefae83392e5b1d76acd8e9e9778e9b2b47ff6", "");
    }
}
